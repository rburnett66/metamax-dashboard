          ...
          <div>
            ...
            <div className="grid grid-cols-4 gap-6">
              {['IDEA', 'DESIGN', 'TECH PLAN', 'DEV'].map((name, i) => (
                <div key={i} className="bg-[#111827] border border-white/10 rounded-3xl p-7 hover:border-[#00AEEF]/50 transition-all">
                  <div className="flex items-start justify-between">
                    <div>
                      <div className="text-[11px] text-white/50 tracking-[1.5px]">STAGE</div>
                      <div className="font-semibold text-2xl tracking-[-0.5px] mt-2">{name}</div>
                    </div>
          ...
          <div className="flex-1">
            ...
            <div className="h-full bg-[#111827] border border-white/10 rounded-3xl p-10 flex items-center justify-center">
              <div className="text-center">
                ...
                <div className="text-lg text-white/70">Activity Window (3 states: Ribbon / Cards / Logs)</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-96 border border-white/10 bg-[#111827] rounded-3xl flex flex-col overflow-hidden">
          ...
          <div className="p-6 border-b border-white/10">
            ...
            <div className="space-y-3">
              <button className="w-full py-3.5 rounded-2xl bg-[#1F2937] hover:bg-[#374151] text-base font-medium transition-colors">⏸ PAUSE</button>
              <button className="w-full py-3.5 rounded-2xl bg-[#FF6B00] hover:bg-[#FF8C33] text-white font-semibold transition-colors">✓ FINISH STAGE</button>
              <button className="w-full py-3.5 rounded-2xl bg-[#1F2937] hover:bg-[#374151] text-base font-medium transition-colors">🔄 ITERATE</button>
            </div>
          </div>
